...
<img class="img-fluid homepagepng w-50 mb-4" src="../assets/images/homepic.png" alt=""></div>
...
<section class="wikies container">
    ...
    <div class="d-flex flex-row justify-content-between flex-lg-wrap flex-wrap ">
        <div class="card text-light mb-3" style="width: 18rem;">
            <div class="card-body">
                <p class="card-title fw-bold">Title : How can you learn programming</p>
                <p class="card-text">Author'sname : TESTING</p>
                <a href="#" class="btn btn-danger text-light d-flex justify-content-center w-75 ms-4">Lire plus</a>
            </div>
        </div>
