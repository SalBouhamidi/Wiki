...
<section class="tags  container">
    <div class="d-flex justify-content-between mb-4">
        ...
        <a href="" class="btn btn-danger text-light fw-semibold px-4 mb-2">Ajouter une categorie</a>
    </div>
    <?php 
...
<section class="tags  container">
    <div class="d-flex justify-content-between mb-4">
        ...
        <a href="" class="btn btn-danger text-light fw-semibold px-5 mb-2">Ajouter un tag</a>
    </div>
